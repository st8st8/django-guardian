...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'guardian.organizationobjectpermission': {
            'Meta': {'unique_together': "([u'organization', u'permission', u'object_pk'],)", 'object_name': 'OrganizationObjectPermission'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_pk': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'organizations.organization': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'through': u"orm['organizations.OrganizationUser']", 'symmetrical': 'False'})
        },
        u'organizations.organizationuser': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'organization_users'", 'to': u"orm['auth.User']"})
        }
    }
